...
package replenishmentv20221107
...
type ListOfferMetricsResponseOffer struct {
	...
	// RevenuePenetration The percentage of total program revenue out of total product revenue. Applicable to PERFORMANCE timePeriodType.
	RevenuePenetration *float64 `json:"revenuePenetration,omitempty"`

	// ShareOfCouponSubscriptions The percentage of new subscriptions acquired through coupons. Applicable to PERFORMANCE timePeriodType.
	ShareOfCouponSubscriptions *float64 `json:"shareOfCouponSubscriptions,omitempty"`

	// ShippedSubscriptionUnits The number of units shipped to the subscribers over a period of time. Applicable to PERFORMANCE timePeriodType.
	ShippedSubscriptionUnits *int64 `json:"shippedSubscriptionUnits,omitempty"`
	...
	// TotalSubscriptionsRevenue The revenue generated from subscriptions over a period of time. Applicable to PERFORMANCE timePeriodType.
	TotalSubscriptionsRevenue *float64 `json:"totalSubscriptionsRevenue,omitempty"`
}
