...
// Defines values for NetCostUnitOfMeasure.
const (
...
const (
	TotalWeightUnitOfMeasureGRAMS     TotalWeightUnitOfMeasure = "GRAMS"
	TotalWeightUnitOfMeasureKILOGRAMS TotalWeightUnitOfMeasure = "KILOGRAMS"
	TotalWeightUnitOfMeasureOUNCES    TotalWeightUnitOfMeasure = "OUNCES"
	TotalWeightUnitOfMeasurePOUNDS    TotalWeightUnitOfMeasure = "POUNDS"
)
...
type SubmitInvoicesRequest struct {
	// Invoices An array of Invoice objects representing the invoices or credit notes to be submitted.
...
type TotalWeight struct {
	...
	// UnitOfMeasure The unit of measure for items sold by weight.
	UnitOfMeasure TotalWeightUnitOfMeasure `json:"unitOfMeasure"`
}

// TotalWeightUnitOfMeasure The unit of measure for items sold by weight.
