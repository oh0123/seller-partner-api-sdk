...
type ClientInterface interface {
	...
	GetInventorySummaries(ctx context.Context, params *GetInventorySummariesParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetInventorySummaries(ctx context.Context, params *GetInventorySummariesParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	GetInventorySummariesWithResponse(ctx context.Context, params *GetInventorySummariesParams, reqEditors ...RequestEditorFn) (*GetInventorySummariesResp, error)
}
...
func (c *ClientWithResponses) GetInventorySummariesWithResponse(ctx context.Context, params *GetInventorySummariesParams, reqEditors ...RequestEditorFn) (*GetInventorySummariesResp, error) {
	rsp, err := c.GetInventorySummaries(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
