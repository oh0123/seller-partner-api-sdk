...
type FeeDetail struct {
	// FeeAmount An object representing a monetary value with its currency information.
	FeeAmount MoneyType `json:"FeeAmount"`

	// FeePromotion An object representing a monetary value with its currency information.
	FeePromotion *MoneyType `json:"FeePromotion,omitempty"`

	// FeeType The type of fee charged to a seller.
	FeeType string `json:"FeeType"`

	// FinalFee An object representing a monetary value with its currency information.
	...
	// TaxAmount An object representing a monetary value with its currency information.
...
type FeesEstimate struct {
	...
	// TotalFeesEstimate An object representing a monetary value with its currency information.
...
type Points struct {
	// PointsMonetaryValue An object representing a monetary value with its currency information.
...
type PriceToEstimateFees struct {
	// ListingPrice An object representing a monetary value with its currency information.
	ListingPrice MoneyType `json:"ListingPrice"`

	// Points The number of Amazon Points offered with the purchase of an item.The Amazon Points program is only available in Japan.
	Points *Points `json:"Points,omitempty"`

	// Shipping An object representing a monetary value with its currency information.
