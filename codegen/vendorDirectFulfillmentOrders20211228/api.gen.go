...
type ClientInterface interface {
	...
	// GetOrder request
	GetOrder(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetOrder(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewSubmitAcknowledgementRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/vendor/directFulfillment/orders/2021-12-28/acknowledgements")
	if operationPath[0] == '/' {
...
func NewGetOrdersRequest(server string, params *GetOrdersParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/vendor/directFulfillment/orders/2021-12-28/purchaseOrders")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetOrderRequest(server string, purchaseOrderNumber string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/vendor/directFulfillment/orders/2021-12-28/purchaseOrders/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	GetOrderWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetOrderResp, error)
}
...
func (c *ClientWithResponses) GetOrderWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetOrderResp, error) {
	rsp, err := c.GetOrder(ctx, purchaseOrderNumber, reqEditors...)
	if err != nil {
		return nil, err
	}
