...
type OrderDetails struct {
	...
	// HasCustomizableItems When `true`, the order contains customizable items.
...
type OrderItem struct {
	// BuyerCustomizedInfo The details of the products the vendor has configured as customizable.
