...
type Address struct {
	...
	// ExtendedFields The container of extended address fields. For example, street name, street number. Only available with Brazil shipping addresses as of now.
...
type AddressExtendedFields struct {
	...
	// Neighborhood The neighborhood. It's smaller than a region and an integral part of an address. It is used in some countries like Brazil.
	Neighborhood *string `json:"Neighborhood,omitempty"`

	// StreetName The street name.
	StreetName *string `json:"StreetName,omitempty"`

	// StreetNumber The house number/building number/property number in the street.
...
type Measurement struct {
	// Unit The unit of measure for this measurement.
...
// MeasurementUnit The unit of measure for this measurement.
...
type Order struct {
	...
	// EarliestDeliveryDate The start of the time period within which you have committed to fulfill the order. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. Returned only for seller-fulfilled orders.
	EarliestDeliveryDate *string `json:"EarliestDeliveryDate,omitempty"`

	// EarliestShipDate The start of the time period within which you have committed to ship the order. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. Returned only for seller-fulfilled orders.
	//
	...
	// IsEstimatedShipDateSet When true, the estimated ship date is specified for the order. Returned only for Sourcing on Demand orders.
	...
	// LatestDeliveryDate The end of the time period within which you have committed to fulfill the order. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. Returned only for seller-fulfilled orders that do not have a `PendingAvailability`, Pending, or Canceled status.
	LatestDeliveryDate *string `json:"LatestDeliveryDate,omitempty"`

	// LatestShipDate The end of the time period within which you have committed to ship the order. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format. Returned only for seller-fulfilled orders.
	//
	...
	// SellerDisplayName The seller’s friendly name registered in the marketplace where the sale took place. Sellers can use this data to issue electronic invoices for orders in Brazil.
	//
...
type OrderAddress struct {
	...
	// BuyerCompanyName The company name of the contact buyer. For Invoice By Amazon (IBA) orders, the buyer company should be Amazon entities.
...
type OrderItem struct {
	...
	// IsTransparency When true, the ASIN is enrolled in Transparency and the Transparency serial number that needs to be submitted can be determined by the following:
	//
	...
	// PriceDesignation Indicates that the selling price is a special price that is available only for Amazon Business orders. For more information about the Amazon Business Seller Program, refer to [Amazon Business](https://business.amazon.com).
	//
	...
	// ScheduledDeliveryEndDate The end date of the scheduled delivery window in the time zone of the order destination. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format.
	ScheduledDeliveryEndDate *string `json:"ScheduledDeliveryEndDate,omitempty"`

	// ScheduledDeliveryStartDate The start date of the scheduled delivery window in the time zone of the order destination. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format.
...
type OrdersList struct {
	// CreatedBefore A date used for selecting orders created before (or at) a specified time. Only orders placed before the specified time are returned. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
	CreatedBefore *string `json:"CreatedBefore,omitempty"`

	// LastUpdatedBefore A date used for selecting orders that were last updated before (or at) a specified time. An update is defined as any change in order status, including the creation of a new order. Includes updates made by Amazon and by the seller. All dates must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
...
type PackageDetail struct {
	// CarrierCode Identifies the carrier that will deliver the package. This field is required for all marketplaces. For the acceptable `CarrierCode` value, refer to the list of <a href='https://images-na.ssl-images-amazon.com/images/G/01/rainier/help/xsd/release_1_9/amzn-base._TTH_.xsd'>CarrierCode</a>.
...
type RegulatedOrderVerificationStatus struct {
	...
	// ReviewDate The date the order was reviewed. In <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> date time format.
...
type GetOrdersParams struct {
	// CreatedAfter A date used for selecting orders created after (or at) a specified time. Only orders placed after the specified time are returned. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
	//
	...
	// EarliestDeliveryDateBefore A date used for selecting orders with a earliest delivery date before (or at) a specified time. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
	EarliestDeliveryDateBefore *string `form:"EarliestDeliveryDateBefore,omitempty" json:"EarliestDeliveryDateBefore,omitempty"`

	// EarliestDeliveryDateAfter A date used for selecting orders with a earliest delivery date after (or at) a specified time. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
	EarliestDeliveryDateAfter *string `form:"EarliestDeliveryDateAfter,omitempty" json:"EarliestDeliveryDateAfter,omitempty"`

	// LatestDeliveryDateBefore A date used for selecting orders with a latest delivery date before (or at) a specified time. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
	LatestDeliveryDateBefore *string `form:"LatestDeliveryDateBefore,omitempty" json:"LatestDeliveryDateBefore,omitempty"`

	// LatestDeliveryDateAfter A date used for selecting orders with a latest delivery date after (or at) a specified time. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
