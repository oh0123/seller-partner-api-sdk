...
func NewGetAccessPointsRequest(server string, params *GetAccessPointsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		headerParam0, err = runtime.StyleParamWithLocation("simple", false, "x-amz-access-token", runtime.ParamLocationHeader, params.XAmzAccessToken)
		if err != nil {
			return nil, err
		}

		req.Header.Set("x-amz-access-token", headerParam0)
