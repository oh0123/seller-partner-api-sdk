...
// Defines values for BusinessContextStoreName.
const (
	BusinessContextStoreNameAMAZONHAUL BusinessContextStoreName = "AMAZON_HAUL"
)

// Defines values for ContextStoreName.
const (
	ContextStoreNameAMAZONHAUL ContextStoreName = "AMAZON_HAUL"
)
...
const (
	...
	FINANCIALEVENTGROUPID RelatedIdentifierRelatedIdentifierName = "FINANCIAL_EVENT_GROUP_ID"
	...
	SETTLEMENTID          RelatedIdentifierRelatedIdentifierName = "SETTLEMENT_ID"
...
type Breakdown struct {
	...
	// Breakdowns A list of breakdowns that detail how the total amount is calculated for the transaction.
...
type BusinessContext struct {
	// StoreName The store name associated with the transaction.
	StoreName *BusinessContextStoreName `json:"storeName,omitempty"`
}

// BusinessContextStoreName The store name associated with the transaction.
type BusinessContextStoreName string
...
type Context struct {
	...
	// StoreName The store name associated with the transaction.
	StoreName *ContextStoreName `json:"storeName,omitempty"`
}

// ContextStoreName The store name associated with the transaction.
type ContextStoreName string
...
type ListTransactionsResponse struct {
	// Payload The payload for the `listTransactions` operation.
...
type MarketplaceDetails struct {
	// MarketplaceId The identifier of the marketplace where the transaction occurred. The marketplace ID is the globally unique identifier of a marketplace. To find the ID for your marketplace, refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).
...
type ListTransactionsParams struct {
	// PostedAfter The response includes financial events posted on or after this date. This date must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format. The date-time must be more than two minutes before the time of the request.
	//
	...
	// MarketplaceId The identifier of the marketplace from which you want to retrieve transactions. The marketplace ID is the globally unique identifier of a marketplace. To find the ID for your marketplace, refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).
	...
	// RelatedIdentifierName The name of the `relatedIdentifier`.
	//
	// **Possible values:**
	//
	...
	RelatedIdentifierName *string `form:"relatedIdentifierName,omitempty" json:"relatedIdentifierName,omitempty"`

	// RelatedIdentifierValue The value of the `relatedIdentifier`.
	RelatedIdentifierValue *string `form:"relatedIdentifierValue,omitempty" json:"relatedIdentifierValue,omitempty"`
...
func NewListTransactionsRequest(server string, params *ListTransactionsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.RelatedIdentifierName != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "relatedIdentifierName", runtime.ParamLocationQuery, *params.RelatedIdentifierName); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.RelatedIdentifierValue != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "relatedIdentifierValue", runtime.ParamLocationQuery, *params.RelatedIdentifierValue); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
