// Package vdftransactionsv20211228 provides primitives to interact with the openapi HTTP API.
//
// Code generated by github.com/deepmap/oapi-codegen/v2 version v2.1.0 DO NOT EDIT.
package vdftransactionsv20211228
...
type CustomeTransactionStatus struct {
...
func NewGetTransactionStatusRequest(server string, transactionId string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/vendor/directFulfillment/transactions/2021-12-28/transactions/%s", pathParam0)
	if operationPath[0] == '/' {
...
type GetTransactionStatusResp struct {
	...
	JSON200      *CustomeTransactionStatus
	JSON400      *ErrorList
	JSON401      *Error
	JSON403      *Error
	JSON404      *Error
...
func ParseGetTransactionStatusResp(rsp *http.Response) (*GetTransactionStatusResp, error) {
	...
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest CustomeTransactionStatus
