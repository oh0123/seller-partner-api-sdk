...
type ClientInterface interface {
	...
	CreateUploadDestinationForResource(ctx context.Context, resource string, params *CreateUploadDestinationForResourceParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) CreateUploadDestinationForResource(ctx context.Context, resource string, params *CreateUploadDestinationForResourceParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	CreateUploadDestinationForResourceWithResponse(ctx context.Context, resource string, params *CreateUploadDestinationForResourceParams, reqEditors ...RequestEditorFn) (*CreateUploadDestinationForResourceResp, error)
}
...
func (c *ClientWithResponses) CreateUploadDestinationForResourceWithResponse(ctx context.Context, resource string, params *CreateUploadDestinationForResourceParams, reqEditors ...RequestEditorFn) (*CreateUploadDestinationForResourceResp, error) {
	rsp, err := c.CreateUploadDestinationForResource(ctx, resource, params, reqEditors...)
	if err != nil {
		return nil, err
	}
