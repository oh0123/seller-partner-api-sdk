...
type BuyBoxPriceType struct {
	// LandedPrice Currency type and monetary value. Schema for demonstrating pricing info.
	...
	// Shipping Currency type and monetary value. Schema for demonstrating pricing info.
	...
	// OfferType Indicates whether the offer is a B2B or B2C offer
...
type CompetitivePricingType struct {
	...
	// TradeInValue Currency type and monetary value. Schema for demonstrating pricing info.
...
type GetOffersResponse struct {
	...
	// Payload The payload for the getListingOffers and getItemOffers operations.
...
type GetOffersResult struct {
	...
	// Offers A list of offer details. The list is the same length as the TotalOfferCount in the Summary or 20, whichever is less.
...
type GetPricingResponse struct {
	...
	// Payload The payload for the `getPricing` and `getCompetitivePricing` operations.
...
type HttpResponseHeaders struct {
	...
	// XAmznRequestId Unique request reference identifier.
...
type IdentifierType struct {
	// MarketplaceASIN Schema to identify an item by MarketPlaceId and ASIN.
	MarketplaceASIN ASINIdentifier `json:"MarketplaceASIN"`

	// SKUIdentifier Schema to identify an item by MarketPlaceId, SellerId, and SellerSKU.
...
type ItemOffersResponse struct {
	...
	// Request List of request parameters that can be accepted by `ItemOffersRequest`
...
type ListingOffersResponse struct {
	...
	// Request List of request parameters that can be accepted by `ListingOffersRequest`
...
type OfferDetail struct {
	...
	// QuantityDiscountPrices List of `QuantityDiscountPrice` that contains item's pricing information when buy in bulk.
...
type OfferType struct {
	// BuyingPrice Schema for item's price information, including listing price, shipping price, and Amazon points.
	...
	// RegularPrice Currency type and monetary value. Schema for demonstrating pricing info.
	RegularPrice MoneyType `json:"RegularPrice"`

	// SellerSKU The seller stock keeping unit (SKU) of the item.
	SellerSKU string `json:"SellerSKU"`

	// BusinessPrice Currency type and monetary value. Schema for demonstrating pricing info.
...
type Summary struct {
	...
	// CompetitivePriceThreshold Currency type and monetary value. Schema for demonstrating pricing info.
	CompetitivePriceThreshold *MoneyType `json:"CompetitivePriceThreshold,omitempty"`

	// ListPrice Currency type and monetary value. Schema for demonstrating pricing info.
	...
	// SuggestedLowerPricePlusShipping Currency type and monetary value. Schema for demonstrating pricing info.
