...
const (
	Air   TransportationDetailsTransportationMode = "Air"
	Ocean TransportationDetailsTransportationMode = "Ocean"
	Road  TransportationDetailsTransportationMode = "Road"
)
...
// CarrierDetails defines model for CarrierDetails.
...
// ContainerSequenceNumbers defines model for ContainerSequenceNumbers.
...
type LabelData struct {
	// CarrierCode Unique identification for  the carrier like UPS,DHL,USPS..etc
	CarrierCode *string `json:"carrierCode,omitempty"`

	// Label Label created as part of the transportation and it is base64 encoded
	Label *string `json:"label,omitempty"`

	// LabelFormat Type of the label format like PDF
	LabelFormat *LabelDataLabelFormat `json:"labelFormat,omitempty"`

	// LabelSequenceNumber Label list sequence number
...
// LabelDataLabelFormat Type of the label format like PDF
...
type ShipmentInformation struct {
	// BuyerReferenceNumber Buyer Reference number which is a unique number.
	BuyerReferenceNumber *string `json:"buyerReferenceNumber,omitempty"`
...
type TransportationDetails struct {
	// BillOfLadingNumber Bill Of Lading (BOL) number is the unique number assigned by the vendor. The BOL present in the Shipment Confirmation message ideally matches the paper BOL provided with the shipment, but that is no must. Instead of BOL, an alternative reference number (like Delivery Note Number) for the shipment can also be sent in this field.
...
type VendorDetails struct {
	...
	// VendorShipmentId Unique vendor shipment id which is not used in last 365 days
...
// Containers defines model for containers.
...
// TransportLabel defines model for transportLabel.
...
// TransportationLabels defines model for transportationLabels.
...
type GetShipmentDetailsParams struct {
	...
	// CreatedAfter Get Shipment Details that became available after this timestamp will be included in the result. Must be in ISO-8601 date/time format.
	CreatedAfter *time.Time `form:"createdAfter,omitempty" json:"createdAfter,omitempty"`

	// CreatedBefore Get Shipment Details that became available before this timestamp will be included in the result. Must be in ISO-8601 date/time format.
	CreatedBefore *time.Time `form:"createdBefore,omitempty" json:"createdBefore,omitempty"`

	// ShipmentConfirmedBefore Get Shipment Details by passing Shipment confirmed create Date Before. Must be in ISO-8601 date/time format.
	ShipmentConfirmedBefore *time.Time `form:"shipmentConfirmedBefore,omitempty" json:"shipmentConfirmedBefore,omitempty"`

	// ShipmentConfirmedAfter Get Shipment Details by passing Shipment confirmed create Date After. Must be in ISO-8601 date/time format.
	ShipmentConfirmedAfter *time.Time `form:"shipmentConfirmedAfter,omitempty" json:"shipmentConfirmedAfter,omitempty"`

	// PackageLabelCreatedBefore Get Shipment Details by passing Package label create Date by buyer. Must be in ISO-8601 date/time format.
	PackageLabelCreatedBefore *time.Time `form:"packageLabelCreatedBefore,omitempty" json:"packageLabelCreatedBefore,omitempty"`

	// PackageLabelCreatedAfter Get Shipment Details by passing Package label create Date After by buyer. Must be in ISO-8601 date/time format.
	PackageLabelCreatedAfter *time.Time `form:"packageLabelCreatedAfter,omitempty" json:"packageLabelCreatedAfter,omitempty"`

	// ShippedBefore Get Shipment Details by passing Shipped Date Before. Must be in ISO-8601 date/time format.
	ShippedBefore *time.Time `form:"shippedBefore,omitempty" json:"shippedBefore,omitempty"`

	// ShippedAfter Get Shipment Details by passing Shipped Date After. Must be in ISO-8601 date/time format.
	ShippedAfter *time.Time `form:"shippedAfter,omitempty" json:"shippedAfter,omitempty"`

	// EstimatedDeliveryBefore Get Shipment Details by passing Estimated Delivery Date Before. Must be in ISO-8601 date/time format.
	EstimatedDeliveryBefore *time.Time `form:"estimatedDeliveryBefore,omitempty" json:"estimatedDeliveryBefore,omitempty"`

	// EstimatedDeliveryAfter Get Shipment Details by passing Estimated Delivery Date Before. Must be in ISO-8601 date/time format.
	EstimatedDeliveryAfter *time.Time `form:"estimatedDeliveryAfter,omitempty" json:"estimatedDeliveryAfter,omitempty"`

	// ShipmentDeliveryBefore Get Shipment Details by passing Shipment Delivery Date Before. Must be in ISO-8601 date/time format.
	ShipmentDeliveryBefore *time.Time `form:"shipmentDeliveryBefore,omitempty" json:"shipmentDeliveryBefore,omitempty"`

	// ShipmentDeliveryAfter Get Shipment Details by passing Shipment Delivery Date After. Must be in ISO-8601 date/time format.
	ShipmentDeliveryAfter *time.Time `form:"shipmentDeliveryAfter,omitempty" json:"shipmentDeliveryAfter,omitempty"`

	// RequestedPickUpBefore Get Shipment Details by passing Before Requested pickup date. Must be in ISO-8601 date/time format.
	RequestedPickUpBefore *time.Time `form:"requestedPickUpBefore,omitempty" json:"requestedPickUpBefore,omitempty"`

	// RequestedPickUpAfter Get Shipment Details by passing After Requested pickup date. Must be in ISO-8601 date/time format.
	RequestedPickUpAfter *time.Time `form:"requestedPickUpAfter,omitempty" json:"requestedPickUpAfter,omitempty"`

	// ScheduledPickUpBefore Get Shipment Details by passing Before scheduled pickup date. Must be in ISO-8601 date/time format.
	ScheduledPickUpBefore *time.Time `form:"scheduledPickUpBefore,omitempty" json:"scheduledPickUpBefore,omitempty"`

	// ScheduledPickUpAfter Get Shipment Details by passing After Scheduled pickup date. Must be in ISO-8601 date/time format.
...
type GetShipmentLabelsParams struct {
	...
	// SortOrder Sort in ascending or descending order by transport label creation date.
	SortOrder *GetShipmentLabelsParamsSortOrder `form:"sortOrder,omitempty" json:"sortOrder,omitempty"`

	// NextToken Used for pagination when there are more transport label than the specified result size limit.
	NextToken *string `form:"nextToken,omitempty" json:"nextToken,omitempty"`

	// LabelCreatedAfter transport Labels that became available after this timestamp will be included in the result. Must be in ISO-8601 date/time format.
	LabelCreatedAfter *time.Time `form:"labelCreatedAfter,omitempty" json:"labelCreatedAfter,omitempty"`

	// LabelcreatedBefore transport Labels that became available before this timestamp will be included in the result. Must be in ISO-8601 date/time format.
	LabelcreatedBefore *time.Time `form:"labelcreatedBefore,omitempty" json:"labelcreatedBefore,omitempty"`

	// BuyerReferenceNumber Get transport labels by passing Buyer Reference Number to retreive the corresponding transport label.
	BuyerReferenceNumber *string `form:"buyerReferenceNumber,omitempty" json:"buyerReferenceNumber,omitempty"`

	// VendorShipmentIdentifier Get transport labels by passing Vendor Shipment ID to retreive the corresponding transport label.
	VendorShipmentIdentifier *string `form:"vendorShipmentIdentifier,omitempty" json:"vendorShipmentIdentifier,omitempty"`

	// SellerWarehouseCode Get Shipping labels based Vendor Warehouse code. This value should be same as 'shipFromParty.partyId' in the Shipment.
	SellerWarehouseCode *string `form:"sellerWarehouseCode,omitempty" json:"sellerWarehouseCode,omitempty"`
}
...
type ClientInterface interface {
	...
	GetShipmentDetails(ctx context.Context, params *GetShipmentDetailsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SubmitShipmentsWithBody request with any body
	SubmitShipmentsWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SubmitShipments(ctx context.Context, body SubmitShipmentsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetShipmentLabels request
	GetShipmentLabels(ctx context.Context, params *GetShipmentLabelsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) GetShipmentDetails(ctx context.Context, params *GetShipmentDetailsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitShipmentsWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitShipments(ctx context.Context, body SubmitShipmentsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetShipmentLabels(ctx context.Context, params *GetShipmentLabelsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	GetShipmentDetailsWithResponse(ctx context.Context, params *GetShipmentDetailsParams, reqEditors ...RequestEditorFn) (*GetShipmentDetailsResp, error)

	// SubmitShipmentsWithBodyWithResponse request with any body
	SubmitShipmentsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShipmentsResp, error)

	SubmitShipmentsWithResponse(ctx context.Context, body SubmitShipmentsJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShipmentsResp, error)

	// GetShipmentLabelsWithResponse request
	GetShipmentLabelsWithResponse(ctx context.Context, params *GetShipmentLabelsParams, reqEditors ...RequestEditorFn) (*GetShipmentLabelsResp, error)
}
...
func (c *ClientWithResponses) GetShipmentDetailsWithResponse(ctx context.Context, params *GetShipmentDetailsParams, reqEditors ...RequestEditorFn) (*GetShipmentDetailsResp, error) {
	rsp, err := c.GetShipmentDetails(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitShipmentsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShipmentsResp, error) {
	rsp, err := c.SubmitShipmentsWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitShipmentsWithResponse(ctx context.Context, body SubmitShipmentsJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShipmentsResp, error) {
	rsp, err := c.SubmitShipments(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSubmitShipmentsResp(rsp)
...
func (c *ClientWithResponses) GetShipmentLabelsWithResponse(ctx context.Context, params *GetShipmentLabelsParams, reqEditors ...RequestEditorFn) (*GetShipmentLabelsResp, error) {
	rsp, err := c.GetShipmentLabels(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
