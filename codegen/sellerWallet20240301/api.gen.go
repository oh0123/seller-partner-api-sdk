...
// Defines values for PayeeEntityType.
const (
	BUSINESS     PayeeEntityType = "BUSINESS"
	INDIVIDUAL   PayeeEntityType = "INDIVIDUAL"
	TAXAUTHORITY PayeeEntityType = "TAX_AUTHORITY"
)
...
type BankAccount struct {
	...
	// RoutingNumber Routing number for automated clearing house transfers for `THIRD_PARTY` transaction requests. This value is nine consecutive zeros for Amazon Seller Wallet accounts.
...
type CreateTransactionResponse struct {
	// CallBackURL The callback URL for the transaction which the user have to click to approve/consent the transaction
...
type Fee struct {
	...
	// FeeRateValue The value of the fee in percentage format.
...
type PayeeContactInformation struct {
	...
	// EmailAddress Email address of the payee.
	...
	// PayeeFirstName First name of the payee. There is a 50 character limit.
	PayeeFirstName string `json:"payeeFirstName"`

	// PayeeLastName Last name of the payee. There is a 50 character limit.
	PayeeLastName string `json:"payeeLastName"`

	// PayeeMiddleName Middle name of the payee. There is a 50 character limit.
	PayeeMiddleName *string `json:"payeeMiddleName,omitempty"`

	// PhoneNumber Valid phone number of the payee.
	PhoneNumber string `json:"phoneNumber"`

	// PostalCode Postal code of the public address.
	PostalCode string `json:"postalCode"`

	// State State name of the public address. This is the state or region for China-based addresses.
...
type Transaction struct {
	// AccountId The unique identifier of the Amazon Seller Wallet bank account from which the money is debited.
	AccountId string `json:"accountId"`
	...
	// TransactionDescription A description of the transaction that the requester provides when they initiate the transaction.
	TransactionDescription string `json:"transactionDescription"`

	// TransactionDestinationAccount Details of the bank account involved in the transaction.
	...
	// TransactionRequestDate The date when the transaction was initiated.
	TransactionRequestDate time.Time `json:"transactionRequestDate"`

	// TransactionRequesterSource The transaction initiation source. This value is either the Amazon portal or PISP name that the customer used to start the transaction.
	TransactionRequesterSource string `json:"transactionRequesterSource"`

	// TransactionSourceAccount Details of the bank account involved in the transaction.
	...
	// TransferRateDetails The fees and foreign exchange rates that apply to the transaction.
	//
...
type TransactionInitiationRequest struct {
	// CustomerPaymentReference If the payment is for VAT (Value-Added-Tax) then enter VAT identification number in this field which will be mandatory. The length constraint is 140 characters and do not allow user to enter any sensitive information other than VAT-ID.
...
type CreateTransactionParams struct {
	...
	// DestAccountDigitalSignature Digital signature for the destination bank account details. For more information, refer to [Third-Party Provider Signature Guidance](https://developer-docs.amazon.com/sp-api/docs/tpp-registration-signature-guidance).
	DestAccountDigitalSignature string `json:"destAccountDigitalSignature"`

	// AmountDigitalSignature Digital signature for the source currency transaction amount. Sign in the order of the request definitions. You can omit empty or optional fields. For more information, refer to [Third-Party Provider Signature Guidance](https://developer-docs.amazon.com/sp-api/docs/tpp-registration-signature-guidance).
...
// DeleteScheduleTransactionParams defines parameters for DeleteScheduleTransaction.
type DeleteScheduleTransactionParams struct {
	// MarketplaceId The marketplace for which items are returned. The marketplace ID is the globally unique identifier of a marketplace. To find the ID for your marketplace, refer to [Marketplace IDs](https://developer-docs.amazon.com/sp-api/docs/marketplace-ids).
	MarketplaceId string `form:"marketplaceId" json:"marketplaceId"`
}

// GetTransferScheduleParams defines parameters for GetTransferSchedule.
...
type ClientInterface interface {
	...
	// GetAccount request
	GetAccount(ctx context.Context, accountId string, params *GetAccountParams) (*http.Response, error)

	// ListAccountBalances request
	ListAccountBalances(ctx context.Context, accountId string, params *ListAccountBalancesParams) (*http.Response, error)
	...
	GetTransaction(ctx context.Context, transactionId string, params *GetTransactionParams) (*http.Response, error)
	...
	DeleteScheduleTransaction(ctx context.Context, transferScheduleId string, params *DeleteScheduleTransactionParams) (*http.Response, error)

	// GetTransferSchedule request
	GetTransferSchedule(ctx context.Context, transferScheduleId string, params *GetTransferScheduleParams) (*http.Response, error)
}
...
func (c *Client) ListAccountBalances(ctx context.Context, accountId string, params *ListAccountBalancesParams) (*http.Response, error) {
	req, err := NewListAccountBalancesRequest(c.Server, accountId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetTransaction(ctx context.Context, transactionId string, params *GetTransactionParams) (*http.Response, error) {
...
func (c *Client) DeleteScheduleTransaction(ctx context.Context, transferScheduleId string, params *DeleteScheduleTransactionParams) (*http.Response, error) {
	req, err := NewDeleteScheduleTransactionRequest(c.Server, transferScheduleId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetTransferSchedule(ctx context.Context, transferScheduleId string, params *GetTransferScheduleParams) (*http.Response, error) {
	req, err := NewGetTransferScheduleRequest(c.Server, transferScheduleId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewListAccountBalancesRequest(server string, accountId string, params *ListAccountBalancesParams) (*http.Request, error) {
	var err error
...
func NewDeleteScheduleTransactionRequest(server string, transferScheduleId string, params *DeleteScheduleTransactionParams) (*http.Request, error) {
	var err error
...
func NewGetTransferScheduleRequest(server string, transferScheduleId string, params *GetTransferScheduleParams) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	GetAccountWithResponse(ctx context.Context, accountId string, params *GetAccountParams) (*GetAccountResp, error)

	// ListAccountBalancesWithResponse request
	ListAccountBalancesWithResponse(ctx context.Context, accountId string, params *ListAccountBalancesParams) (*ListAccountBalancesResp, error)
	...
	GetTransactionWithResponse(ctx context.Context, transactionId string, params *GetTransactionParams) (*GetTransactionResp, error)
	...
	DeleteScheduleTransactionWithResponse(ctx context.Context, transferScheduleId string, params *DeleteScheduleTransactionParams) (*DeleteScheduleTransactionResp, error)

	// GetTransferScheduleWithResponse request
	GetTransferScheduleWithResponse(ctx context.Context, transferScheduleId string, params *GetTransferScheduleParams) (*GetTransferScheduleResp, error)
}
...
type CreateTransactionResp struct {
	Body         []byte // Might be nil if decoded via streaming
	HTTPResponse *http.Response
	JSON200      *CreateTransactionResponse
	JSON400      *ErrorList
	JSON403      *ErrorList
	JSON404      *ErrorList
	JSON408      *ErrorList
...
func (c *ClientWithResponses) GetAccountWithResponse(ctx context.Context, accountId string, params *GetAccountParams) (*GetAccountResp, error) {
	rsp, err := c.GetAccount(ctx, accountId, params)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) ListAccountBalancesWithResponse(ctx context.Context, accountId string, params *ListAccountBalancesParams) (*ListAccountBalancesResp, error) {
	rsp, err := c.ListAccountBalances(ctx, accountId, params)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetTransactionWithResponse(ctx context.Context, transactionId string, params *GetTransactionParams) (*GetTransactionResp, error) {
	rsp, err := c.GetTransaction(ctx, transactionId, params)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) DeleteScheduleTransactionWithResponse(ctx context.Context, transferScheduleId string, params *DeleteScheduleTransactionParams) (*DeleteScheduleTransactionResp, error) {
	rsp, err := c.DeleteScheduleTransaction(ctx, transferScheduleId, params)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetTransferScheduleWithResponse(ctx context.Context, transferScheduleId string, params *GetTransferScheduleParams) (*GetTransferScheduleResp, error) {
	rsp, err := c.GetTransferSchedule(ctx, transferScheduleId, params)
	if err != nil {
		return nil, err
	}
...
func ParseListAccountsResp(rsp *http.Response) (*ListAccountsResp, error) {
	...
	case strings.Contains(contentType, "json") && rsp.StatusCode == 404:
		...
		return response, nil
	case strings.Contains(contentType, "json") && rsp.StatusCode == 408:
		var dest ErrorList
		if err := JSONNewDecoder(rsp.Body).Decode(&dest); err != nil && err != io.EOF {
			return nil, err
		}
...
func ParseCreateTransactionResp(rsp *http.Response) (*CreateTransactionResp, error) {
	...
	switch {
	case strings.Contains(contentType, "json") && rsp.StatusCode == 200:
		var dest CreateTransactionResponse
		if err := JSONNewDecoder(rsp.Body).Decode(&dest); err != nil && err != io.EOF {
			return nil, err
		}
		response.JSON200 = &dest
