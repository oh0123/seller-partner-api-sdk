...
type ClientInterface interface {
	...
	GetOrderMetrics(ctx context.Context, params *GetOrderMetricsParams, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetOrderMetrics(ctx context.Context, params *GetOrderMetricsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	GetOrderMetricsWithResponse(ctx context.Context, params *GetOrderMetricsParams, reqEditors ...RequestEditorFn) (*GetOrderMetricsResp, error)
}
...
func (c *ClientWithResponses) GetOrderMetricsWithResponse(ctx context.Context, params *GetOrderMetricsParams, reqEditors ...RequestEditorFn) (*GetOrderMetricsResp, error) {
	rsp, err := c.GetOrderMetrics(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
