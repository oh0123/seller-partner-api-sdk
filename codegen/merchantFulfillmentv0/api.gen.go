...
const (
	FBMSHIPPLUSCREDIT RateItemID = "FBM_SHIP_PLUS_CREDIT"
)
...
type RateItem struct {
	// RateItemCharge Currency type and amount.
	...
	// RateItemNameLocalization Localized name for the RateItem.
...
type ShippingService struct {
	...
	// RateWithAdjustments Currency type and amount.
