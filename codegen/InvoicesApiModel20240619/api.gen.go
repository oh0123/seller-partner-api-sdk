...
// Defines values for GovernmentInvoiceCreationStatus.
const (
...
const (
	DONE       GetInvoicesExportsParamsStatus = "DONE"
	ERROR      GetInvoicesExportsParamsStatus = "ERROR"
	PROCESSING GetInvoicesExportsParamsStatus = "PROCESSING"
	REQUESTED  GetInvoicesExportsParamsStatus = "REQUESTED"
)
...
type CarrierDetailsContext struct {
	// Address The address of the carrier, as registered in state and federal tax authorities.
	Address *string `json:"address,omitempty"`

	// ContextType Type of additional information.
	ContextType *string `json:"contextType,omitempty"`

	// FederalTaxId Tax Identification number of the carrier.
	FederalTaxId *string `json:"federalTaxId,omitempty"`

	// Name The name of the carrier, as registered in state and federal tax authorities.
	Name *string `json:"name,omitempty"`

	// RegionCode The code of the federal subdivision in which the carrier is registered.
	RegionCode *string `json:"regionCode,omitempty"`

	// RegionTaxId The regional tax registration number of the carrier.
	RegionTaxId *string `json:"regionTaxId,omitempty"`

	// VehicleLicensePlate The identifier for the carrier vehicle as printed in its registration plate.
	VehicleLicensePlate *string `json:"vehicleLicensePlate,omitempty"`

	// VehicleRegistrationRegionCode The code of the federal subdivision in which the carrier vehicle is registered.
...
type GovernmentInvoiceRequest struct {
	// Contexts Object that contains additional invoice creation information
	Contexts *[]CarrierDetailsContext `json:"contexts,omitempty"`

	// InboundPlanId The unique InboundPlan identifier in which the shipment is contained and for which the invoice will be created.
	InboundPlanId *string `json:"inboundPlanId,omitempty"`

	// InvoiceType Marketplace specific classification of the invoice type. Check 'invoiceType' options using 'getInvoicesAttributes' operation.
	InvoiceType string `json:"invoiceType"`

	// MarketplaceId The government invoices creation request will match the national authoritative source of the given marketplace.
	MarketplaceId string `json:"marketplaceId"`

	// ShipmentId The unique shipment identifier to get an invoice for.
	ShipmentId string `json:"shipmentId"`

	// TransactionType Marketplace specific classification of the transaction type that originated the invoice. Check 'transactionType' options using 'getInvoicesAttributes' operation.
	TransactionType string `json:"transactionType"`
}

// GovernmentInvoiceStatusResponse Success.
type GovernmentInvoiceStatusResponse struct {
	// InvoiceErrors The errors that occurred during invoice creation.
	InvoiceErrors *[]InvoiceError `json:"invoiceErrors,omitempty"`

	// InvoiceExternalDocumentId Government Invoice ID of a successfully authorized invoice.
	InvoiceExternalDocumentId *string `json:"invoiceExternalDocumentId,omitempty"`

	// Status The current status of a government invoice creation request.
...
type InvoiceDocument struct {
	// InvoiceDocumentUrl A pre-signed URL to download the invoice document in its original format. This URL expires after 30 seconds.
...
// GetGovernmentInvoiceStatusParams defines parameters for GetGovernmentInvoiceStatus.
type GetGovernmentInvoiceStatusParams struct {
	// MarketplaceId The invoices status will match the marketplace that you specify.
	MarketplaceId string `form:"marketplaceId" json:"marketplaceId"`
	...
	// InvoiceType Marketplace specific classification of the invoice type. Check 'invoiceType' options using 'getInvoicesAttributes' operation.
	InvoiceType string `form:"invoiceType" json:"invoiceType"`

	// InboundPlanId The unique InboundPlan identifier in which the shipment is contained and for which the invoice will be created.
	InboundPlanId *string `form:"inboundPlanId,omitempty" json:"inboundPlanId,omitempty"`
}

// GetGovernmentInvoiceDocumentParams defines parameters for GetGovernmentInvoiceDocument.
type GetGovernmentInvoiceDocumentParams struct {
	// MarketplaceId The invoices returned will match the marketplace that you specify.
	MarketplaceId string `form:"marketplaceId" json:"marketplaceId"`
	...
	// FileFormat Requested file format. Default is XML
	FileFormat *string `form:"fileFormat,omitempty" json:"fileFormat,omitempty"`
}
...
// CreateGovernmentInvoiceJSONRequestBody defines body for CreateGovernmentInvoice for application/json ContentType.
type CreateGovernmentInvoiceJSONRequestBody = GovernmentInvoiceRequest
...
type ClientInterface interface {
	...
	// GetGovernmentInvoiceStatus request
	GetGovernmentInvoiceStatus(ctx context.Context, params *GetGovernmentInvoiceStatusParams) (*http.Response, error)

	// CreateGovernmentInvoiceWithBody request with any body
	CreateGovernmentInvoiceWithBody(ctx context.Context, contentType string, body io.Reader) (*http.Response, error)

	CreateGovernmentInvoice(ctx context.Context, body CreateGovernmentInvoiceJSONRequestBody) (*http.Response, error)

	// GetGovernmentInvoiceDocument request
	GetGovernmentInvoiceDocument(ctx context.Context, shipmentId string, params *GetGovernmentInvoiceDocumentParams) (*http.Response, error)
...
func (c *Client) GetGovernmentInvoiceStatus(ctx context.Context, params *GetGovernmentInvoiceStatusParams) (*http.Response, error) {
	req, err := NewGetGovernmentInvoiceStatusRequest(c.Server, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateGovernmentInvoiceWithBody(ctx context.Context, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewCreateGovernmentInvoiceRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) CreateGovernmentInvoice(ctx context.Context, body CreateGovernmentInvoiceJSONRequestBody) (*http.Response, error) {
	req, err := NewCreateGovernmentInvoiceRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetGovernmentInvoiceDocument(ctx context.Context, shipmentId string, params *GetGovernmentInvoiceDocumentParams) (*http.Response, error) {
	req, err := NewGetGovernmentInvoiceDocumentRequest(c.Server, shipmentId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetGovernmentInvoiceStatusRequest generates requests for GetGovernmentInvoiceStatus
func NewGetGovernmentInvoiceStatusRequest(server string, params *GetGovernmentInvoiceStatusParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/tax/invoices/2024-06-19/governmentInvoiceRequests")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params != nil {
		...
		if params.InboundPlanId != nil {

			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "inboundPlanId", runtime.ParamLocationQuery, *params.InboundPlanId); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
// NewCreateGovernmentInvoiceRequest calls the generic CreateGovernmentInvoice builder with application/json body
func NewCreateGovernmentInvoiceRequest(server string, body CreateGovernmentInvoiceJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := JSONMarshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewCreateGovernmentInvoiceRequestWithBody(server, "application/json", bodyReader)
}

// NewCreateGovernmentInvoiceRequestWithBody generates requests for CreateGovernmentInvoice with any type of body
func NewCreateGovernmentInvoiceRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewGetGovernmentInvoiceDocumentRequest generates requests for GetGovernmentInvoiceDocument
func NewGetGovernmentInvoiceDocumentRequest(server string, shipmentId string, params *GetGovernmentInvoiceDocumentParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/tax/invoices/2024-06-19/governmentInvoiceRequests/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params != nil {
		...
		if params.FileFormat != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "fileFormat", runtime.ParamLocationQuery, *params.FileFormat); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
type ClientWithResponsesInterface interface {
	...
	// GetGovernmentInvoiceStatusWithResponse request
	GetGovernmentInvoiceStatusWithResponse(ctx context.Context, params *GetGovernmentInvoiceStatusParams) (*GetGovernmentInvoiceStatusResp, error)

	// CreateGovernmentInvoiceWithBodyWithResponse request with any body
	CreateGovernmentInvoiceWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader) (*CreateGovernmentInvoiceResp, error)

	CreateGovernmentInvoiceWithResponse(ctx context.Context, body CreateGovernmentInvoiceJSONRequestBody) (*CreateGovernmentInvoiceResp, error)

	// GetGovernmentInvoiceDocumentWithResponse request
	GetGovernmentInvoiceDocumentWithResponse(ctx context.Context, shipmentId string, params *GetGovernmentInvoiceDocumentParams) (*GetGovernmentInvoiceDocumentResp, error)
...
type GetGovernmentInvoiceStatusResp struct {
	Body         []byte // Might be nil if decoded via streaming
	HTTPResponse *http.Response
	JSON200      *GovernmentInvoiceStatusResponse
	JSON400      *ErrorList
	JSON401      *ErrorList
	JSON403      *ErrorList
	JSON404      *ErrorList
...
// Status returns HTTPResponse.Status
func (r GetGovernmentInvoiceStatusResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetGovernmentInvoiceStatusResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type CreateGovernmentInvoiceResp struct {
	Body         []byte // Might be nil if decoded via streaming
	HTTPResponse *http.Response
	JSON400      *ErrorList
	JSON401      *ErrorList
...
// Status returns HTTPResponse.Status
func (r CreateGovernmentInvoiceResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r CreateGovernmentInvoiceResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetGovernmentInvoiceDocumentResp struct {
	Body         []byte // Might be nil if decoded via streaming
	HTTPResponse *http.Response
	JSON200      *GovtInvoiceDocumentResponse
	JSON400      *ErrorList
	JSON401      *ErrorList
	JSON403      *ErrorList
	JSON404      *ErrorList
...
// Status returns HTTPResponse.Status
func (r GetGovernmentInvoiceDocumentResp) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetGovernmentInvoiceDocumentResp) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetGovernmentInvoiceStatusWithResponse request returning *GetGovernmentInvoiceStatusResp
func (c *ClientWithResponses) GetGovernmentInvoiceStatusWithResponse(ctx context.Context, params *GetGovernmentInvoiceStatusParams) (*GetGovernmentInvoiceStatusResp, error) {
	rsp, err := c.GetGovernmentInvoiceStatus(ctx, params)
	if err != nil {
		return nil, err
	}
	return ParseGetGovernmentInvoiceStatusResp(rsp)
}

// CreateGovernmentInvoiceWithBodyWithResponse request with arbitrary body returning *CreateGovernmentInvoiceResp
func (c *ClientWithResponses) CreateGovernmentInvoiceWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader) (*CreateGovernmentInvoiceResp, error) {
	rsp, err := c.CreateGovernmentInvoiceWithBody(ctx, contentType, body)
	if err != nil {
		return nil, err
	}
	return ParseCreateGovernmentInvoiceResp(rsp)
}

func (c *ClientWithResponses) CreateGovernmentInvoiceWithResponse(ctx context.Context, body CreateGovernmentInvoiceJSONRequestBody) (*CreateGovernmentInvoiceResp, error) {
	rsp, err := c.CreateGovernmentInvoice(ctx, body)
	if err != nil {
		return nil, err
	}
	return ParseCreateGovernmentInvoiceResp(rsp)
...
// GetGovernmentInvoiceDocumentWithResponse request returning *GetGovernmentInvoiceDocumentResp
func (c *ClientWithResponses) GetGovernmentInvoiceDocumentWithResponse(ctx context.Context, shipmentId string, params *GetGovernmentInvoiceDocumentParams) (*GetGovernmentInvoiceDocumentResp, error) {
	rsp, err := c.GetGovernmentInvoiceDocument(ctx, shipmentId, params)
	if err != nil {
		return nil, err
	}
	return ParseGetGovernmentInvoiceDocumentResp(rsp)
}
...
// ParseGetGovernmentInvoiceStatusResp parses an HTTP response from a GetGovernmentInvoiceStatusWithResponse call
func ParseGetGovernmentInvoiceStatusResp(rsp *http.Response) (*GetGovernmentInvoiceStatusResp, error) {
	defer func() { _ = rsp.Body.Close() }()

	response := &GetGovernmentInvoiceStatusResp{
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(contentType, "json") && rsp.StatusCode == 200:
		var dest GovernmentInvoiceStatusResponse
		if err := JSONNewDecoder(rsp.Body).Decode(&dest); err != nil && err != io.EOF {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseCreateGovernmentInvoiceResp parses an HTTP response from a CreateGovernmentInvoiceWithResponse call
func ParseCreateGovernmentInvoiceResp(rsp *http.Response) (*CreateGovernmentInvoiceResp, error) {
	defer func() { _ = rsp.Body.Close() }()

	response := &CreateGovernmentInvoiceResp{
		HTTPResponse: rsp,
	}
...
// ParseGetGovernmentInvoiceDocumentResp parses an HTTP response from a GetGovernmentInvoiceDocumentWithResponse call
func ParseGetGovernmentInvoiceDocumentResp(rsp *http.Response) (*GetGovernmentInvoiceDocumentResp, error) {
	defer func() { _ = rsp.Body.Close() }()

	response := &GetGovernmentInvoiceDocumentResp{
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(contentType, "json") && rsp.StatusCode == 200:
		var dest GovtInvoiceDocumentResponse
		if err := JSONNewDecoder(rsp.Body).Decode(&dest); err != nil && err != io.EOF {
			return nil, err
		}
		response.JSON200 = &dest
