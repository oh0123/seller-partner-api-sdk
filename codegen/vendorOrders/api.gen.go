...
// Defines values for MoneyUnitOfMeasure.
const (
	GRAMS     MoneyUnitOfMeasure = "GRAMS"
	KILOGRAMS MoneyUnitOfMeasure = "KILOGRAMS"
	OUNCES    MoneyUnitOfMeasure = "OUNCES"
	POUNDS    MoneyUnitOfMeasure = "POUNDS"
)
...
type Money struct {
	...
	// UnitOfMeasure The unit of measure for prices of items sold by weight. If this field is absent, the item is sold by eaches.
	UnitOfMeasure *MoneyUnitOfMeasure `json:"unitOfMeasure,omitempty"`
}
...
type OrderAcknowledgementItem struct {
	...
	// ListPrice An amount of money. Includes the currency code and an optional unit of measure for items priced by weight.
	ListPrice *Money `json:"listPrice,omitempty"`

	// NetCost An amount of money. Includes the currency code and an optional unit of measure for items priced by weight.
