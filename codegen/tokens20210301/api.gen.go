...
type ClientInterface interface {
	...
	CreateRestrictedDataTokenWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateRestrictedDataToken(ctx context.Context, body CreateRestrictedDataTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) CreateRestrictedDataTokenWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateRestrictedDataToken(ctx context.Context, body CreateRestrictedDataTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	CreateRestrictedDataTokenWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateRestrictedDataTokenResp, error)

	CreateRestrictedDataTokenWithResponse(ctx context.Context, body CreateRestrictedDataTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateRestrictedDataTokenResp, error)
}
...
func (c *ClientWithResponses) CreateRestrictedDataTokenWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateRestrictedDataTokenResp, error) {
	rsp, err := c.CreateRestrictedDataTokenWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateRestrictedDataTokenWithResponse(ctx context.Context, body CreateRestrictedDataTokenJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateRestrictedDataTokenResp, error) {
	rsp, err := c.CreateRestrictedDataToken(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateRestrictedDataTokenResp(rsp)
