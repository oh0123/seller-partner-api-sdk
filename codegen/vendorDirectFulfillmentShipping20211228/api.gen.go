...
type StatusUpdateDetails struct {
	// ReasonCode Provides a reason code for the status of the package that will provide additional information about the transportation status.
	ReasonCode string `json:"reasonCode"`

	// ShipmentSchedule Details about the estimated delivery window.
	ShipmentSchedule *ShipmentSchedule `json:"shipmentSchedule,omitempty"`

	// StatusCode Indicates the shipment status code of the package that provides transportation information for Amazon tracking systems and ultimately for the final customer.
...
type ClientInterface interface {
	...
	GetCustomerInvoices(ctx context.Context, params *GetCustomerInvoicesParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetCustomerInvoice request
	GetCustomerInvoice(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetPackingSlips request
	GetPackingSlips(ctx context.Context, params *GetPackingSlipsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetPackingSlip request
	GetPackingSlip(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	SubmitShipmentStatusUpdatesWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SubmitShipmentStatusUpdates(ctx context.Context, body SubmitShipmentStatusUpdatesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetShippingLabels request
	GetShippingLabels(ctx context.Context, params *GetShippingLabelsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// SubmitShippingLabelRequestWithBody request with any body
	SubmitShippingLabelRequestWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SubmitShippingLabelRequest(ctx context.Context, body SubmitShippingLabelRequestJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetShippingLabel request
	GetShippingLabel(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// CreateShippingLabelsWithBody request with any body
	CreateShippingLabelsWithBody(ctx context.Context, purchaseOrderNumber string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	CreateShippingLabels(ctx context.Context, purchaseOrderNumber string, body CreateShippingLabelsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetCustomerInvoices(ctx context.Context, params *GetCustomerInvoicesParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetCustomerInvoice(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetPackingSlips(ctx context.Context, params *GetPackingSlipsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetPackingSlip(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitShipmentStatusUpdatesWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitShipmentStatusUpdates(ctx context.Context, body SubmitShipmentStatusUpdatesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetShippingLabels(ctx context.Context, params *GetShippingLabelsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitShippingLabelRequestWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitShippingLabelRequest(ctx context.Context, body SubmitShippingLabelRequestJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) GetShippingLabel(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateShippingLabelsWithBody(ctx context.Context, purchaseOrderNumber string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) CreateShippingLabels(ctx context.Context, purchaseOrderNumber string, body CreateShippingLabelsJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	GetCustomerInvoicesWithResponse(ctx context.Context, params *GetCustomerInvoicesParams, reqEditors ...RequestEditorFn) (*GetCustomerInvoicesResp, error)

	// GetCustomerInvoiceWithResponse request
	GetCustomerInvoiceWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetCustomerInvoiceResp, error)

	// GetPackingSlipsWithResponse request
	GetPackingSlipsWithResponse(ctx context.Context, params *GetPackingSlipsParams, reqEditors ...RequestEditorFn) (*GetPackingSlipsResp, error)

	// GetPackingSlipWithResponse request
	GetPackingSlipWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetPackingSlipResp, error)

	// SubmitShipmentConfirmationsWithBodyWithResponse request with any body
	SubmitShipmentConfirmationsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShipmentConfirmationsResp, error)

	SubmitShipmentConfirmationsWithResponse(ctx context.Context, body SubmitShipmentConfirmationsJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShipmentConfirmationsResp, error)

	// SubmitShipmentStatusUpdatesWithBodyWithResponse request with any body
	SubmitShipmentStatusUpdatesWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShipmentStatusUpdatesResp, error)

	SubmitShipmentStatusUpdatesWithResponse(ctx context.Context, body SubmitShipmentStatusUpdatesJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShipmentStatusUpdatesResp, error)

	// GetShippingLabelsWithResponse request
	GetShippingLabelsWithResponse(ctx context.Context, params *GetShippingLabelsParams, reqEditors ...RequestEditorFn) (*GetShippingLabelsResp, error)

	// SubmitShippingLabelRequestWithBodyWithResponse request with any body
	SubmitShippingLabelRequestWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShippingLabelRequestResp, error)

	SubmitShippingLabelRequestWithResponse(ctx context.Context, body SubmitShippingLabelRequestJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShippingLabelRequestResp, error)

	// GetShippingLabelWithResponse request
	GetShippingLabelWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetShippingLabelResp, error)

	// CreateShippingLabelsWithBodyWithResponse request with any body
	CreateShippingLabelsWithBodyWithResponse(ctx context.Context, purchaseOrderNumber string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateShippingLabelsResp, error)

	CreateShippingLabelsWithResponse(ctx context.Context, purchaseOrderNumber string, body CreateShippingLabelsJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateShippingLabelsResp, error)
}
...
func (c *ClientWithResponses) GetCustomerInvoicesWithResponse(ctx context.Context, params *GetCustomerInvoicesParams, reqEditors ...RequestEditorFn) (*GetCustomerInvoicesResp, error) {
	rsp, err := c.GetCustomerInvoices(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetCustomerInvoiceWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetCustomerInvoiceResp, error) {
	rsp, err := c.GetCustomerInvoice(ctx, purchaseOrderNumber, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetPackingSlipsWithResponse(ctx context.Context, params *GetPackingSlipsParams, reqEditors ...RequestEditorFn) (*GetPackingSlipsResp, error) {
	rsp, err := c.GetPackingSlips(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetPackingSlipWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetPackingSlipResp, error) {
	rsp, err := c.GetPackingSlip(ctx, purchaseOrderNumber, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitShipmentConfirmationsWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShipmentConfirmationsResp, error) {
...
func (c *ClientWithResponses) SubmitShipmentConfirmationsWithResponse(ctx context.Context, body SubmitShipmentConfirmationsJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShipmentConfirmationsResp, error) {
...
func (c *ClientWithResponses) SubmitShipmentStatusUpdatesWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShipmentStatusUpdatesResp, error) {
	rsp, err := c.SubmitShipmentStatusUpdatesWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitShipmentStatusUpdatesWithResponse(ctx context.Context, body SubmitShipmentStatusUpdatesJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShipmentStatusUpdatesResp, error) {
	rsp, err := c.SubmitShipmentStatusUpdates(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSubmitShipmentStatusUpdatesResp(rsp)
...
func (c *ClientWithResponses) GetShippingLabelsWithResponse(ctx context.Context, params *GetShippingLabelsParams, reqEditors ...RequestEditorFn) (*GetShippingLabelsResp, error) {
	rsp, err := c.GetShippingLabels(ctx, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitShippingLabelRequestWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitShippingLabelRequestResp, error) {
	rsp, err := c.SubmitShippingLabelRequestWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitShippingLabelRequestWithResponse(ctx context.Context, body SubmitShippingLabelRequestJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitShippingLabelRequestResp, error) {
	rsp, err := c.SubmitShippingLabelRequest(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSubmitShippingLabelRequestResp(rsp)
...
func (c *ClientWithResponses) GetShippingLabelWithResponse(ctx context.Context, purchaseOrderNumber string, reqEditors ...RequestEditorFn) (*GetShippingLabelResp, error) {
	rsp, err := c.GetShippingLabel(ctx, purchaseOrderNumber, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateShippingLabelsWithBodyWithResponse(ctx context.Context, purchaseOrderNumber string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*CreateShippingLabelsResp, error) {
	rsp, err := c.CreateShippingLabelsWithBody(ctx, purchaseOrderNumber, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) CreateShippingLabelsWithResponse(ctx context.Context, purchaseOrderNumber string, body CreateShippingLabelsJSONRequestBody, reqEditors ...RequestEditorFn) (*CreateShippingLabelsResp, error) {
	rsp, err := c.CreateShippingLabels(ctx, purchaseOrderNumber, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseCreateShippingLabelsResp(rsp)
