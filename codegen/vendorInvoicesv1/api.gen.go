...
type Address struct {
	...
	// PostalOrZipCode The postal or zip code of that address. It contains a series of letters, digits, or both, sometimes including spaces or punctuation.
...
type CreditNoteDetails struct {
	...
	// GoodsReturnDate Defines a date and time according to <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a>.
...
type Invoice struct {
	...
	// Date Defines a date and time according to <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a>.
...
type InvoiceItem struct {
	...
	// HsnCode The HSN Tax code. The HSN number cannot contain alphabets.
