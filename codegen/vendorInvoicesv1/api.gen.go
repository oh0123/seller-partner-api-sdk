...
type ClientInterface interface {
	...
	SubmitInvoicesWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	SubmitInvoices(ctx context.Context, body SubmitInvoicesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) SubmitInvoicesWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func (c *Client) SubmitInvoices(ctx context.Context, body SubmitInvoicesJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
type ClientWithResponsesInterface interface {
	...
	SubmitInvoicesWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitInvoicesResp, error)

	SubmitInvoicesWithResponse(ctx context.Context, body SubmitInvoicesJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitInvoicesResp, error)
}
...
func (c *ClientWithResponses) SubmitInvoicesWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*SubmitInvoicesResp, error) {
	rsp, err := c.SubmitInvoicesWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) SubmitInvoicesWithResponse(ctx context.Context, body SubmitInvoicesJSONRequestBody, reqEditors ...RequestEditorFn) (*SubmitInvoicesResp, error) {
	rsp, err := c.SubmitInvoices(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseSubmitInvoicesResp(rsp)
