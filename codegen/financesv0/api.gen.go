...
type ChargeRefundEvent struct {
	// ChargeRefundTransactions The charge refund transaction.
...
type ListFinancialEventGroupsParams struct {
	...
	// FinancialEventGroupStartedAfter A date used for selecting financial event groups that opened after (or at) a specified date and time, in ISO 8601 format. The date-time must be no later than two minutes before the request was submitted.
...
type ListFinancialEventsByGroupIdParams struct {
	...
	// PostedAfter A date used for selecting financial events posted after (or at) a specified time. The date-time **must** be more than two minutes before the time of the request, in ISO 8601 date time format.
...
type ListFinancialEventsParams struct {
	...
	// PostedAfter A date used for selecting financial events posted after (or at) a specified time. The date-time must be no later than two minutes before the request was submitted, in ISO 8601 date time format.
	PostedAfter *time.Time `form:"PostedAfter,omitempty" json:"PostedAfter,omitempty"`
...
type ClientWithResponsesInterface interface {
	...
	ListFinancialEventGroupsWithResponse(ctx context.Context, params *ListFinancialEventGroupsParams, reqEditors ...RequestEditorFn) (*ListFinancialEventGroupsResp, error)

	// ListFinancialEventsByGroupIdWithResponse request
	ListFinancialEventsByGroupIdWithResponse(ctx context.Context, eventGroupId string, params *ListFinancialEventsByGroupIdParams, reqEditors ...RequestEditorFn) (*ListFinancialEventsByGroupIdResp, error)

	// ListFinancialEventsWithResponse request
	ListFinancialEventsWithResponse(ctx context.Context, params *ListFinancialEventsParams, reqEditors ...RequestEditorFn) (*ListFinancialEventsResp, error)

	// ListFinancialEventsByOrderIdWithResponse request
	ListFinancialEventsByOrderIdWithResponse(ctx context.Context, orderId string, params *ListFinancialEventsByOrderIdParams, reqEditors ...RequestEditorFn) (*ListFinancialEventsByOrderIdResp, error)
}
...
func (c *ClientWithResponses) ListFinancialEventGroupsWithResponse(ctx context.Context, params *ListFinancialEventGroupsParams, reqEditors ...RequestEditorFn) (*ListFinancialEventGroupsResp, error) {
...
func (c *ClientWithResponses) ListFinancialEventsByGroupIdWithResponse(ctx context.Context, eventGroupId string, params *ListFinancialEventsByGroupIdParams, reqEditors ...RequestEditorFn) (*ListFinancialEventsByGroupIdResp, error) {
...
func (c *ClientWithResponses) ListFinancialEventsWithResponse(ctx context.Context, params *ListFinancialEventsParams, reqEditors ...RequestEditorFn) (*ListFinancialEventsResp, error) {
...
func (c *ClientWithResponses) ListFinancialEventsByOrderIdWithResponse(ctx context.Context, orderId string, params *ListFinancialEventsByOrderIdParams, reqEditors ...RequestEditorFn) (*ListFinancialEventsByOrderIdResp, error) {
