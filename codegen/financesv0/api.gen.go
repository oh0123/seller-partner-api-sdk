...
type AdhocDisbursementEvent struct {
	...
	// TransactionType The type of transaction. For example, "Disbursed to Amazon Gift Card balance".
...
type AdjustmentItem struct {
	...
	// Quantity Represents the number of units in the seller's inventory when the `AdjustmentType` is `FBAInventoryReimbursement`.
...
type AffordabilityExpenseEvent struct {
	...
	// MarketplaceId The Amazon-defined marketplace identifier.
...
type CapacityReservationBillingEvent struct {
	...
	// TransactionType The transaction type. For example, FBA Inventory Fee.
	TransactionType *string `json:"TransactionType,omitempty"`
}
...
type ChargeRefundEvent struct {
	...
	// ReasonCode The reason given for a charge refund. For example, `SubscriptionFeeCorrection`.
	ReasonCode *string `json:"ReasonCode,omitempty"`

	// ReasonCodeDescription A description of the Reason Code. For example, `SubscriptionFeeCorrection`.
...
type DebtRecoveryItem struct {
	// GroupBeginDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
	GroupBeginDate *Date `json:"GroupBeginDate,omitempty"`

	// GroupEndDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
...
type FailedAdhocDisbursementEvent struct {
	...
	// FundsTransfersType The type of fund transfer. For example, `Refund`.
	FundsTransfersType *string `json:"FundsTransfersType,omitempty"`

	// PaymentDisbursementType The type of payment for disbursement. For example, `CREDIT_CARD`.
	PaymentDisbursementType *string `json:"PaymentDisbursementType,omitempty"`

	// PostedDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
	PostedDate *Date `json:"PostedDate,omitempty"`

	// Status The status of the failed `AdhocDisbursement`. For example, `HARD_DECLINED`.
...
type FinancialEventGroup struct {
	...
	// FinancialEventGroupEnd A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
	...
	// FinancialEventGroupStart A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
	FinancialEventGroupStart *Date `json:"FinancialEventGroupStart,omitempty"`

	// FundTransferDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
...
type FinancialEvents struct {
	...
	// ServiceProviderCreditEventList A list of `SolutionProviderCreditEvent`.
...
type PayWithAmazonEvent struct {
	...
	// TransactionPostedDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
...
type ProductAdsPaymentEvent struct {
	...
	// InvoiceId The identifier for the invoice that includes the transaction.
...
type RemovalShipmentAdjustmentEvent struct {
	...
	// RemovalShipmentItemAdjustmentList A comma-delimited list of `RemovalShipmentItemAdjustment` details for FBA inventory.
...
type RemovalShipmentItem struct {
	...
	// TaxCollectionModel The tax collection model that is applied to the item.
	//
	// Possible values:
	//
...
type RemovalShipmentItemAdjustment struct {
	// AdjustedQuantity Adjusted quantity of `RemovalShipmentItemAdjustment` items.
...
type SolutionProviderCreditEvent struct {
	...
	// TransactionCreationDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
...
type TaxWithholdingPeriod struct {
	// EndDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
	EndDate *Date `json:"EndDate,omitempty"`

	// StartDate A date in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) date-time format.
...
type ValueAddedServiceChargeEvent struct {
	...
	// TransactionType The transaction type. For example, 'Other Support Service fees'
	TransactionType *string `json:"TransactionType,omitempty"`
}
...
type ListFinancialEventGroupsParams struct {
	...
	// FinancialEventGroupStartedAfter A date that selects financial event groups that opened after (or at) a specified date and time, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format. The date-time must be more than two minutes before you submit the request.
...
type ListFinancialEventsByGroupIdParams struct {
	// MaxResultsPerPage The maximum number of results to return per page. If the response exceeds the maximum number of transactions or 10 MB, the response is `InvalidInput`.
	MaxResultsPerPage *int32 `form:"MaxResultsPerPage,omitempty" json:"MaxResultsPerPage,omitempty"`
