...
type GetSellingPartnerMetricsResponseMetric struct {
	// ActiveSubscriptions The number of active subscriptions present at the end of the period. Applicable to `PERFORMANCE` `timePeriodType`.
	ActiveSubscriptions *float32 `json:"activeSubscriptions,omitempty"`

	// CouponsRevenuePenetration The percentage of revenue from ASINs with coupons out of total revenue from all ASINs. Applicable to `PERFORMANCE` `timePeriodType`.
	...
	// EstablishedSubscriberLifeTimeValueFromOTP Revenue from one-time purchase orders placed by customers who have maintained an active subscription with your catalog for more than 12 months.
	EstablishedSubscriberLifeTimeValueFromOTP *float64 `json:"establishedSubscriberLifeTimeValueFromOTP,omitempty"`

	// EstablishedSubscriberLifeTimeValueFromSNS Revenue from Subscribe & Save orders placed by customers who have maintained an active subscription with your catalog for more than 12 months.
	EstablishedSubscriberLifeTimeValueFromSNS *float64 `json:"establishedSubscriberLifeTimeValueFromSNS,omitempty"`

	// GrowingSubscriberLifeTimeValueFromOTP Revenue from one-time purchase orders placed by customers who started their first subscription with your catalog within the past 12 months.
	GrowingSubscriberLifeTimeValueFromOTP *float64 `json:"growingSubscriberLifeTimeValueFromOTP,omitempty"`

	// GrowingSubscriberLifeTimeValueFromSNS Revenue from Subscribe & Save orders placed by customers who started their first subscription with your catalog within the past 12 months.
	GrowingSubscriberLifeTimeValueFromSNS *float64 `json:"growingSubscriberLifeTimeValueFromSNS,omitempty"`

	// LostRevenueDueToOOS The revenue that would have been generated had there not been out of stock. Applicable to `PERFORMANCE` `timePeriodType`.
	LostRevenueDueToOOS *float64 `json:"lostRevenueDueToOOS,omitempty"`

	// LostSubscriberLifeTimeValueFromOTP Revenue from one-time purchase orders placed by customers who previously had subscriptions but currently have none active in your catalog.
	LostSubscriberLifeTimeValueFromOTP *float64 `json:"lostSubscriberLifeTimeValueFromOTP,omitempty"`

	// LostSubscriberLifeTimeValueFromSNS Revenue from Subscribe & Save orders placed by customers who previously had subscriptions but currently have none active in your catalog.
	LostSubscriberLifeTimeValueFromSNS *float64 `json:"lostSubscriberLifeTimeValueFromSNS,omitempty"`

	// NonSubscriberAverageReorders The average reorders per non-subscriber of the program over a period of past 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	NonSubscriberAverageReorders *float64 `json:"nonSubscriberAverageReorders,omitempty"`

	// NonSubscriberAverageRevenue The average revenue per non-subscriber of the program over a period of past 12 months for sellers and 6 months for vendors. Applicable to `PERFORMANCE` `timePeriodType`.
	NonSubscriberAverageRevenue *float64 `json:"nonSubscriberAverageRevenue,omitempty"`

	// NonSubscriberLifeTimeValueFromOTP Total revenue from customers who have made purchases from your catalog but have never subscribed to any products
	NonSubscriberLifeTimeValueFromOTP *float64 `json:"nonSubscriberLifeTimeValueFromOTP,omitempty"`

	// NotDeliveredDueToOOS The percentage of items that were not shipped out of the total shipped units over a period of time due to being out of stock. Applicable to `PERFORMANCE` `timePeriodType`.
	NotDeliveredDueToOOS *float64 `json:"notDeliveredDueToOOS,omitempty"`

	// RevenueFromActiveSubscriptionsWithSingleDelivery The subscription revenue generated from active subscriptions with one delivery over the past 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	RevenueFromActiveSubscriptionsWithSingleDelivery *float64 `json:"revenueFromActiveSubscriptionsWithSingleDelivery,omitempty"`

	// RevenueFromCancelledSubscriptionsAfterSingleDelivery The subscription revenue generated from subscriptions which are cancelled after one delivery over the past 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	...
	// RevenueFromSubscriptionsWithMultipleDeliveries The subscription revenue generated from subscriptions with over two deliveries over the past 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	RevenueFromSubscriptionsWithMultipleDeliveries *float64 `json:"revenueFromSubscriptionsWithMultipleDeliveries,omitempty"`

	// RevenuePenetrationFor0PercentSellerFunding The percentage of subscription revenue generated by offers with 0% seller-funded discount over the last 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	RevenuePenetrationFor0PercentSellerFunding *float64 `json:"revenuePenetrationFor0PercentSellerFunding,omitempty"`

	// RevenuePenetrationFor10PercentSellerFunding [Applicable only for Sellers] The percentage of subscription revenue generated by offers with 10% seller-funded discount over the last 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	RevenuePenetrationFor10PercentSellerFunding *float64 `json:"revenuePenetrationFor10PercentSellerFunding,omitempty"`

	// RevenuePenetrationFor5PercentSellerFunding [Applicable only for Sellers] The percentage of subscription revenue generated by offers with 5% seller-funded discount over the last 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	RevenuePenetrationFor5PercentSellerFunding *float64 `json:"revenuePenetrationFor5PercentSellerFunding,omitempty"`

	// RevenuePenetrationFor5PlusPercentSellerFunding [Applicable only for vendors] The percentage of subscription revenue generated by offers with 5% or above seller-funded discount over the last 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	RevenuePenetrationFor5PlusPercentSellerFunding *float64 `json:"revenuePenetrationFor5PlusPercentSellerFunding,omitempty"`

	// ShareOfCouponSubscriptions The percentage of new subscriptions acquired through coupons. Applicable to `PERFORMANCE` `timePeriodType`.
	...
	// SignupConversionFor0PercentSellerFunding Percentage of subscriptions created by offers with 0% seller-funded discount out of the total number of new orders placed over the past 12 months
	SignupConversionFor0PercentSellerFunding *float64 `json:"signupConversionFor0PercentSellerFunding,omitempty"`

	// SignupConversionFor10PercentSellerFunding [Applicable only for Sellers] Percentage of subscriptions created by offers with 10% seller-funded discount out of the total number of new orders placed over the past 12 months
	SignupConversionFor10PercentSellerFunding *float64 `json:"signupConversionFor10PercentSellerFunding,omitempty"`

	// SignupConversionFor5PercentSellerFunding [Applicable only for Sellers] Percentage of subscriptions created by offers with 5% seller-funded discount out of the total number of new orders placed over the past 12 months
	SignupConversionFor5PercentSellerFunding *float64 `json:"signupConversionFor5PercentSellerFunding,omitempty"`

	// SignupConversionFor5PlusPercentSellerFunding [Applicable only for Vendors] Percentage of subscriptions created by offers with 5% or above seller-funded discount out of the total number of new orders placed over the past 12 months
	SignupConversionFor5PlusPercentSellerFunding *float64 `json:"signupConversionFor5PlusPercentSellerFunding,omitempty"`

	// SubscriberAverageReorders The average reorders per subscriber of the program over a period of 12 months. Applicable to `PERFORMANCE` `timePeriodType`.
	SubscriberAverageReorders *float64 `json:"subscriberAverageReorders,omitempty"`

	// SubscriberAverageRevenue The average revenue per subscriber of the program over a period of past 12 months for sellers and 6 months for vendors. Applicable to `PERFORMANCE` `timePeriodType`.
	SubscriberAverageRevenue *float64 `json:"subscriberAverageRevenue,omitempty"`

	// SubscriberRetentionFor30Days The percentage of subscriptions retained after 30 days of subscription creation. Applicable to `PERFORMANCE` `timePeriodType`.
	SubscriberRetentionFor30Days *float64 `json:"subscriberRetentionFor30Days,omitempty"`

	// SubscriberRetentionFor90Days The percentage of subscriptions retained after 90 days of subscription creation. Applicable to `PERFORMANCE` `timePeriodType`.
...
type ListOfferMetricsResponseOffer struct {
	// ActiveSubscriptions The number of active subscriptions present at the end of the period. Applicable to `FORECAST` `timePeriodType`.
	ActiveSubscriptions *float32 `json:"activeSubscriptions,omitempty"`

	// Asin The Amazon Standard Identification Number (ASIN).
	Asin *string `json:"asin,omitempty"`

	// CouponsRevenuePenetration The percentage of revenue from ASINs with coupons out of total revenue from all ASINs. Applicable to `FORECAST` `timePeriodType`.
	CouponsRevenuePenetration *float64 `json:"couponsRevenuePenetration,omitempty"`

	// CurrencyCode The currency code in ISO 4217 format.
	CurrencyCode *string `json:"currencyCode,omitempty"`

	// LostRevenueDueToOOS The revenue that would have been generated had there not been out of stock. Applicable to `FORECAST` `timePeriodType`.
	LostRevenueDueToOOS *float64 `json:"lostRevenueDueToOOS,omitempty"`

	// Next30DayShippedSubscriptionUnits The forecasted shipped subscription units for the next 30 days. Applicable to FORECAST timePeriodType.
	Next30DayShippedSubscriptionUnits *float32 `json:"next30DayShippedSubscriptionUnits,omitempty"`

	// Next30DayTotalSubscriptionsRevenue The forecasted total subscription revenue for the next 30 days. Applicable to FORECAST timePeriodType.
	Next30DayTotalSubscriptionsRevenue *float64 `json:"next30DayTotalSubscriptionsRevenue,omitempty"`

	// Next60DayShippedSubscriptionUnits The forecasted shipped subscription units for the next 60 days. Applicable to FORECAST timePeriodType.
	Next60DayShippedSubscriptionUnits *float32 `json:"next60DayShippedSubscriptionUnits,omitempty"`

	// Next60DayTotalSubscriptionsRevenue The forecasted total subscription revenue for the next 60 days. Applicable to FORECAST timePeriodType.
	Next60DayTotalSubscriptionsRevenue *float64 `json:"next60DayTotalSubscriptionsRevenue,omitempty"`

	// Next90DayShippedSubscriptionUnits The forecasted shipped subscription units for the next 90 days. Applicable to FORECAST timePeriodType.
	Next90DayShippedSubscriptionUnits *float32 `json:"next90DayShippedSubscriptionUnits,omitempty"`

	// Next90DayTotalSubscriptionsRevenue The forecasted total subscription revenue for the next 90 days. Applicable to FORECAST timePeriodType.
	Next90DayTotalSubscriptionsRevenue *float64 `json:"next90DayTotalSubscriptionsRevenue,omitempty"`

	// NotDeliveredDueToOOS The percentage of items that were not shipped out of the total shipped units over a period of time due to being out of stock. Applicable to `FORECAST` `timePeriodType`.
	NotDeliveredDueToOOS *float64 `json:"notDeliveredDueToOOS,omitempty"`

	// RevenuePenetration The percentage of total program revenue out of total product revenue. Applicable to `FORECAST` `timePeriodType`.
	RevenuePenetration *float64 `json:"revenuePenetration,omitempty"`

	// ShareOfCouponSubscriptions The percentage of new subscriptions acquired through coupons. Applicable to `FORECAST` `timePeriodType`.
	ShareOfCouponSubscriptions *float64 `json:"shareOfCouponSubscriptions,omitempty"`

	// ShippedSubscriptionUnits The number of units shipped to the subscribers over a period of time. Applicable to `FORECAST` `timePeriodType`.
	ShippedSubscriptionUnits *float32 `json:"shippedSubscriptionUnits,omitempty"`
	...
	// TotalSubscriptionsRevenue The revenue generated from subscriptions over a period of time. Applicable to `FORECAST` `timePeriodType`.
	TotalSubscriptionsRevenue *float64 `json:"totalSubscriptionsRevenue,omitempty"`
}
